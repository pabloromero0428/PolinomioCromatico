...
public class ControlPolyC {
    ...
    public void guardarResultados(String path) {
        try {
            ...
            pw.println("T: " + time_end + " P(G,x): " + "Prueba");//polynom.writePoly());
    ...
    public void fileMove(String sourceFile, String destinationFile) throws FileNotFoundException, IOException {
